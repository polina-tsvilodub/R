...
author: "Polina Tsvilodub, Leona Bätz"
output:
  html_document
---
...
I am running R on x86_64-w64-mingw32 in version R version 3.5.3 (2019-03-11)
...
iris_tibble$supp is of type Integer.
...
30 gunieapigs were fed with orange juice
...
# YOUR CODE HERE
iris_tibble %>% group_by(supp) %>% summarise(mean(len))
...
The mean tooth length in orange juice condition is 20.66333
...
# YOUR CODE HERE
ggplot(data=iris_tibble, aes(x = dose, y = len, color = supp))+ 
  geom_point() 
...
For dose 0.5 the guineapigs recieving orange juice seem to have the longer teeth, for a dose of 1.0 as well while for a dose of 2.0 it seems to be more mixed.
